...
import images from "../data/country";
...
const OurService = () => {
  ...
  return (
    <section className="py-16 bg-white w-full px-4 md:px-10">
      <motion.div
      ...
      {/* SLIDER CONTAINER WAJIB FULL WIDTH */}
          ...
          {images.map((country, index) => (
            <div key={index} className="px-2"> 
              <motion.div
                ...
                className="bg-gray-50 rounded-xl shadow hover:shadow-xl overflow-hidden transition"
              >
                <img
                  src={country.src}
                  alt={country.name}
